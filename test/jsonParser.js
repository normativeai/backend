...
describe("Three passes JSON parser", function() {
  ...
  it(`should parse paragraphs 1,2,3 and 4 of the GDPR article 13 correctly`, function(done){
    ...
    let par3 = (JSON.parse(fs.readFileSync("./test/fixtures/gdpr_13_3.json", "utf8")));
    let par4 = (JSON.parse(fs.readFileSync("./test/fixtures/gdpr_13_4.json", "utf8")));
    let res = threePasses([par1,par2,par3,par4])
    ...
    expect(res[2]).to.equal("(((((((((((((earlier(Time,Time2) , personal_data_processed(Processor, Data, Time2, Justification2, Purpose2)) , different_from(Purpose2, Purpose)) , ((~ already_has(Subject, purpose_of_processing(Purpose2, Data))) , (((((processor(Processor) , nominate(Controller, Processor)) , personal_data_processed(Processor, Data, Time, Justification, Purpose)) , personal_data(Data,Subject)) , data_subject(Subject)) , controller(Controller, Data)))) O> communicate_at_time(Controller, Subject, Time2, purpose_of_processing(Purpose2, Data))) , ((((earlier(Time,Time2) , personal_data_processed(Processor, Data, Time2, Justification2, Purpose2)) , different_from(Purpose2, Purpose)) , ((~ already_has(Subject, stored_during(Data, Period))) , (((((processor(Processor) , nominate(Controller, Processor)) , personal_data_processed(Processor, Data, Time, Justification, Purpose)) , personal_data(Data,Subject)) , data_subject(Subject)) , controller(Controller, Data)))) O> communicate_at_time(Controller, Subject, Time2, stored_during(Data, Period)))) , (((((earlier(Time,Time2) , personal_data_processed(Processor, Data, Time2, Justification2, Purpose2)) , different_from(Purpose2, Purpose)) , ((~ already_has(Subject, criteria_storing_data(Data,Criteria))) , (((((processor(Processor) , nominate(Controller, Processor)) , personal_data_processed(Processor, Data, Time, Justification, Purpose)) , personal_data(Data,Subject)) , data_subject(Subject)) , controller(Controller, Data)))) , (~ stored_during(Data, Period))) O> communicate_at_time(Controller, Subject, Time2, criteria_storing_data(Data,Criteria)))) , ((((earlier(Time,Time2) , personal_data_processed(Processor, Data, Time2, Justification2, Purpose2)) , different_from(Purpose2, Purpose)) , ((~ already_has(Subject, existence_right_of(Controller, Subject, Data, access_rectification_etc))) , (((((processor(Processor) , nominate(Controller, Processor)) , personal_data_processed(Processor, Data, Time, Justification, Purpose)) , personal_data(Data,Subject)) , data_subject(Subject)) , controller(Controller, Data)))) O> communicate_at_time(Controller, Subject, Time2, existence_right_of(Controller, Subject, Data, access_rectification_etc)))) , (((((earlier(Time,Time2) , personal_data_processed(Processor, Data, Time2, Justification2, Purpose2)) , different_from(Purpose2, Purpose)) , ((~ already_has(Subject, existence_right_of(Controller, Subject, Data, withdraw_consent_etc))) , (((((processor(Processor) , nominate(Controller, Processor)) , personal_data_processed(Processor, Data, Time, Justification, Purpose)) , personal_data(Data,Subject)) , data_subject(Subject)) , controller(Controller, Data)))) , personal_data_processed_at_time(Processor, Data, Time, article_6_1_article_9_2_a)) O> communicate_at_time(Controller, Subject, Time2, existence_right_of(Controller, Subject, Data, withdraw_consent_etc)))) , ((((earlier(Time,Time2) , personal_data_processed(Processor, Data, Time2, Justification2, Purpose2)) , different_from(Purpose2, Purpose)) , ((~ already_has(Subject, existence_right_of(Controller, Subject, Data, lodge_complaint))) , (((((processor(Processor) , nominate(Controller, Processor)) , personal_data_processed(Processor, Data, Time, Justification, Purpose)) , personal_data(Data,Subject)) , data_subject(Subject)) , controller(Controller, Data)))) O> communicate_at_time(Controller, Subject, Time2, existence_right_of(Controller, Subject, Data, lodge_complaint)))) , (((((earlier(Time,Time2) , personal_data_processed(Processor, Data, Time2, Justification2, Purpose2)) , different_from(Purpose2, Purpose)) , ((~ already_has(Subject, info(ProvisionType))) , (((((processor(Processor) , nominate(Controller, Processor)) , personal_data_processed(Processor, Data, Time, Justification, Purpose)) , personal_data(Data,Subject)) , data_subject(Subject)) , controller(Controller, Data)))) , type_provision(Subject, Data, ProvisionType)) O> communicate_at_time(Controller, Subject, Time2, info(ProvisionType)))) , ((((earlier(Time,Time2) , personal_data_processed(Processor, Data, Time2, Justification2, Purpose2)) , different_from(Purpose2, Purpose)) , ((~ already_has(Subject, info(ProvisionType))) , (((((processor(Processor) , nominate(Controller, Processor)) , personal_data_processed(Processor, Data, Time, Justification, Purpose)) , personal_data(Data,Subject)) , data_subject(Subject)) , controller(Controller, Data)))) O> communicate_at_time(Controller, Subject, Time2, info(ProvisionType)))) , (((((earlier(Time,Time2) , personal_data_processed(Processor, Data, Time2, Justification2, Purpose2)) , different_from(Purpose2, Purpose)) , ((~ already_has(Subject, info_obliged_give_data(IsObliged, Consequences))) , (((((processor(Processor) , nominate(Controller, Processor)) , personal_data_processed(Processor, Data, Time, Justification, Purpose)) , personal_data(Data,Subject)) , data_subject(Subject)) , controller(Controller, Data)))) , (is_obliged_to_give(Subject,Data,IsObliged) , consequence_refusing_to_give(Subject,Data, Consequences))) O> communicate_at_time(Controller, Subject, Time2, info_obliged_give_data(IsObliged, Consequences)))) , ((((earlier(Time,Time2) , personal_data_processed(Processor, Data, Time2, Justification2, Purpose2)) , different_from(Purpose2, Purpose)) , ((~ already_has(Subject, existence_ai(Data,Algorithm))) , (((((processor(Processor) , nominate(Controller, Processor)) , personal_data_processed(Processor, Data, Time, Justification, Purpose)) , personal_data(Data,Subject)) , data_subject(Subject)) , controller(Controller, Data)))) O> communicate_at_time(Controller, Subject, Time2, existence_ai(Data,Algorithm))))")
    done();
  });
