...
describe("Update theory", function(){
  ...
  it("should check that the auto formalization were updated correctly on GDPR article 13", async function(){
  ...
  it("should report correct errors if the auto formaliztion were not updated correctly 1", function(done){
      const t = Object.assign({}, theory);
...
describe("Checking theory static computeViolations", function(){
    ...
    let json =  {
      ...
      "connective": {
        "name": "Always Obligation / If",
        "description": "It Ought to be ___ If ___",
        "code": "obonif",
        "formulas": [
          {
            "text": "A contract",
